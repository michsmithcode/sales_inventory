    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'SUPER ADMIN'), ('manager', 'MANAGER'), ('sales_rep', 'SALES REPRESENTATIVE'), ('store_keeper', 'STORE KEEPER'), ('accountant', 'ACCOUNTANT')], max_length=50)),
